<template>
  <div class="game-layout">
    ...
    <main class="container">
      ...
      >
        <h2 v-if="!isKeyboardOpen || showAnswer">Which flag is this?</h2>
        <div ref="flagContainerRef" class="flag-container">
          <img
        ...
        <div v-if="!showAnswer" class="input-section">
          ...
          <div class="button-container">
            ...
            <button :disabled="!isValidGuess" @click="submitGuess">
              Submit
            </button>
          </div>
        </div>
...
const isValidGuess = computed(() => {
  ...
  return countries.value.some(
    (c) => normalizeString(c.name) === normalizedGuess
  );
});
